...
public class InterceptorImpl implements ExtensionHandler, RuntimeFactoryAware {
    ...
    public @NotNull String getTemplateName() {
        return "interceptor.java";
    }

    @Override
    public @NotNull Map<String, Object> getObjectMap() {
        Map<String, Object> objectMap = new HashMap<>();
        objectMap.put("packageName", runtimeFactory.getPackage(PathEnum.pkg) + ".interceptor");
    ...
    public @NotNull String getOutputFilePath() {
        return this.runtimeFactory.getRelativePath(PathEnum.pkg) + "/interceptor";
    }
